...
const shortestWord = string => {
  let currentShortest = "Pneumonoultramicroscopicsilicovolcanoconiosis";
  return string.split(' ').reduce((currentShortest, currentWord) => {
    return ((currentWord.length <= currentShortest.length) ? currentShortest = currentWord : currentShortest)
  }, currentShortest)
}
