...
//     let modifiedArray = stringAsArray.map((element => element[0].toUpperCase() + element.toLowerCase().slice(1)))
//     return modifiedArray.join('')
// }

const snakeToCamel = string => {
    return string.split('_').map((element => element[0].toUpperCase() + element.toLowerCase().slice(1))).join('')
}
